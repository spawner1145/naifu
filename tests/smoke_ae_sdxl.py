"""测试结果:
Using device: cuda
FluxVAE encode/decode smoke
input -> (1, 3, 32, 32), latent -> (1, 16, 4, 4), recon -> (1, 3, 32, 32)
mean abs diff: 0.813604
_merge_state_dict channel copy
overlap diff (expect 0): 0.000000
FluxVAE channel assert (should fail when mismatched)
caught AssertionError as expected: UNet channels must match Flux VAE z_channels; adapters are disabled.
SDXL checkpoint filtering for flux_vae_path override
original first_stage_model.* keys: 248
filtered first_stage_model.* keys: 0 (expect 0)
Partial merge shape check (4c -> 16c)
copied diff (expect 0): 0.000000
checkpoint header read
ae.safetensors exists: True, sdxl.safetensors exists: True
ae keys sample (244 total): ['decoder.conv_in.bias', 'decoder.conv_in.weight', 'decoder.conv_out.bias', 'decoder.conv_out.weight', 'decoder.mid.attn_1.k.bias']
sdxl keys sample (2514 total): ['conditioner.embedders.0.transformer.text_model.embeddings.position_embedding.weight', 'conditioner.embedders.0.transformer.text_model.embeddings.token_embedding.weight', 'conditioner.embedders.0.transformer.text_model.encoder.layers.0.layer_norm1.bias', 'conditioner.embedders.0.transformer.text_model.encoder.layers.0.layer_norm1.weight', 'conditioner.embedders.0.transformer.text_model.encoder.layers.0.layer_norm2.bias']
first tensor conditioner.embedders.0.transformer.text_model.embeddings.position_embedding.weight shape: (77, 768)
INFO - Constructing UNet with 3 levels, [1, 2, 4] channels and [1, 2, 10] transformer blocks per level
INFO - Initialized embedder #0: FrozenCLIPEmbedder with 123060480 params. Trainable: False
INFO - Initialized embedder #1: FrozenOpenCLIPEmbedder2 with 694659841 params. Trainable: False
INFO - Initialized embedder #2: ConcatTimestepEmbedderND with 0 params. Trainable: False
INFO - Initialized embedder #3: ConcatTimestepEmbedderND with 0 params. Trainable: False
INFO - Initialized embedder #4: ConcatTimestepEmbedderND with 0 params. Trainable: False
INFO - Loading model from D:\code\naifu1\sdxl\sdxl.safetensors
D:\Python311\Lib\site-packages\torch\utils\checkpoint.py:85: UserWarning: None of the inputs have requires_grad=True. Gradients will be None
  warnings.warn(
UNet output shape: (1, 16, 8, 8)
Decoded image shape: (1, 3, 64, 64)
Flux VAE save/load roundtrip
saved 244 tensors, reloaded 244 tensors
Flux VAE encode/decode on synthetic geometric image
saved input -> tmp_geom_input.png, recon -> tmp_geom_recon.png, mse=0.003020
State reuse stats (exclude VAE)
INFO - Constructing UNet with 3 levels, [1, 2, 4] channels and [1, 2, 10] transformer blocks per level
INFO - Initialized embedder #0: FrozenCLIPEmbedder with 123060480 params. Trainable: False
INFO - Initialized embedder #1: FrozenOpenCLIPEmbedder2 with 694659841 params. Trainable: False
INFO - Initialized embedder #2: ConcatTimestepEmbedderND with 0 params. Trainable: False
...
INFO - Initialized embedder #4: ConcatTimestepEmbedderND with 0 params. Trainable: False
INFO - Loading model from D:\code\naifu1\sdxl\sdxl.safetensors
preserved: 2263, partial(replaced): 3, missing(new keys): 0, preserved% (of keys with source) = 99.87%
mismatched layers (source_shape -> target_shape), first 20
model.diffusion_model.input_blocks.0.0.weight: (320, 4, 3, 3) -> (320, 16, 3, 3)
model.diffusion_model.out.2.weight: (4, 320, 3, 3) -> (16, 320, 3, 3)
model.diffusion_model.out.2.bias: (4,) -> (16,)
"""
